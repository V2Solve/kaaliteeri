...
let room = new Room();
let game = new KaaliTeeriGame("XYZ",room);
game.addGamingPlayer(new GamingPlayer(game,new Person("xyz","Saurin")))
game.addGamingPlayer(new GamingPlayer(game,new Person("avd","Mita")))
game.addGamingPlayer(new GamingPlayer(game,new Person("xfd","Sonu")))
game.addGamingPlayer(new GamingPlayer(game,new Person("skd","Niyati")))
game.addGamingPlayer(new GamingPlayer(game,new Person("iek","Pramit")))
